...
public class CounterFrame extends javax.swing.JFrame {
     ...
     */
    // =========================================================================
    private void displayErrorMessage(int errCode) {
        if (errCode != 0) {
            String errMsg = Counter.getErrorMessage(errCode);
