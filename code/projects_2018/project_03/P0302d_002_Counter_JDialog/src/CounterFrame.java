...
public class CounterFrame extends javax.swing.JFrame {
    ...
    private void printErrorMessage( int errorCode ) {
        ...
        if ( errorCode != 0 ){
            JLabel dialogLabel = new JLabel(errorMessage[errorCode]);
            dialogLabel.setForeground(Color.RED);
            dialogLabel.setFont(new java.awt.Font("MS UI Gothic", 0, 36));
            errorMsgDialog.setBounds(0,0,100,50);
            errorMsgDialog.setLayout(new FlowLayout());
            errorMsgDialog.add(dialogLabel);
            errorMsgDialog.pack();
            errorMsgDialog.setVisible(true);
        } else {
            errorMsgDialog.setVisible(false);
        }
        // ---------------------------------------------------------------------
    }
    // =========================================================================
